...
class EffectShopPage extends StatefulWidget {
  const EffectShopPage({super.key});

  @override
  State<EffectShopPage> createState() => _EffectShopPageState();
}

class _EffectShopPageState extends State<EffectShopPage> {
