...
import '../lib/medal_page.dart';

void main() {
  group('MedalPage Tests', () {
    testWidgets('MedalPage should build without errors', (WidgetTester tester) async {
    ...
    testWidgets('MedalPage should display filter options', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: MedalPage()));
    ...
    testWidgets('MedalPage should have back button', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: MedalPage()));
